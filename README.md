...
3. If `_email_test` is set to `true`, a test email is sent to specified addresses via your Mandrill API key.
...
This makes it easy to refresh your Preview URL locally, push DispatchWire, with your Preview templates, to a remote URL to share those with your team for review, and provides a Live email ready to post to your Email Service Provider.
...
If you don't have Composer, you can [install it within the root dispatchwire directory](https://getcomposer.org/doc/00-intro.md#locally). Once you've done so, run:
